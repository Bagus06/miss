...
--
-- Host: localhost:3306
-- Generation Time: 13 Nov 2019 pada 01.26
...
id`,
`user_id
`, `nama`, `kode`, `gender`, `alamat`, `hp`, `photo`, `created`, `updated`) VALUES
...
id`,
`siswa_id
`, `kelas_id`, `keterangan`, `tanggal`) VALUES
(1, 6, 1, 1, '2019-11-13'),
(2, 11, 1, 2, '2019-11-13'),
(6, 12, 1, 1, '2019-11-13');
...
`th_ajaran_id`,
`angkatan
`, `nama`, `nis`, `nisn`, `gender`, `photo`, `tmpt_lhr`, `tgl_lhr`, `alamat`) VALUES
...
`, `password`, `email`, `token`, `active`, `created`, `updated`) VALUES
...
id`,
`title
`, `description`, `level`, `created`, `updated`) VALUES
...
ADD KEY `mapel_id`
(`mapel_id`),
ADD KEY `guru_has_mapel_ibfk_3`
(`kelas_id`),
ADD KEY `th_ajaran_id`
(`th_ajaran_id`);
...
ALTER TABLE `user_has_role`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
...
--
ALTER TABLE `guru_has_mapel`
ADD CONSTRAINT `guru_has_mapel_ibfk_1` FOREIGN KEY
(`guru_id`) REFERENCES `guru`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `guru_has_mapel_ibfk_2` FOREIGN KEY
(`mapel_id`) REFERENCES `mapel`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `guru_has_mapel_ibfk_3` FOREIGN KEY
(`kelas_id`) REFERENCES `kelas`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `guru_has_mapel_ibfk_4` FOREIGN KEY
(`th_ajaran_id`) REFERENCES `th_ajaran`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `presensi`
ADD CONSTRAINT `presensi_ibfk_1` FOREIGN KEY
(`siswa_id`) REFERENCES `siswa`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `presensi_ibfk_2` FOREIGN KEY
(`kelas_id`) REFERENCES `kelas`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `siswa_ibfk_3` FOREIGN KEY
(`th_ajaran_id`) REFERENCES `th_ajaran`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `siswa_ibfk_4` FOREIGN KEY
(`angkatan`) REFERENCES `th_ajaran`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE;
...
--
ALTER TABLE `user_has_role`
ADD CONSTRAINT `user_has_role_ibfk_1` FOREIGN KEY
(`user_id`) REFERENCES `user`
(`id`) ON
DELETE CASCADE ON
UPDATE CASCADE,
ADD CONSTRAINT `user_has_role_ibfk_2` FOREIGN KEY
